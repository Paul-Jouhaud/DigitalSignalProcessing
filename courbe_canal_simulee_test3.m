...
formant_filtre = formantcos(SURECHANTILLONNAGE*TAILLE_FORMANT+1, ...
SURECHANTILLONNAGE);
...
for x = (0:0.1:8)
  ...
  current_teb_max = 0;
  for y=1:10
    temp_teb = erreur_canal(x, TAILLE_MESSAGE, SURECHANTILLONNAGE,...
    formant_base, formant_filtre, canal);
